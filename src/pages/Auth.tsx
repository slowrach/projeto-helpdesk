...
export function Auth() {
  ...
  return (
    <div className="h-full w-full bg-[url(assets/bg.png)] pt-8">
      <div className="h-full w-full flex-col rounded-t-[1.25rem] bg-white">
        ...
        {signUp ? (
          <div className="flex flex-col items-center gap-3">
            ...
            <div className="flex w-86 flex-col rounded-lg border border-gray-500 p-7">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <div className="flex w-86 flex-col rounded-lg border border-gray-500 p-7">
              ...
              <p className="mb-6 text-xs text-gray-300">Cadastre agora mesmo</p>
